...
/*********************************************************
 * EGYWIN — GRAND TOUR EDITION (Cream/Cacao, Tailwind v4)
 * Layout unchanged; content + images updated from profile.
 *********************************************************/
...
/** Curated, relevant placeholders (windows/doors/uPVC/aluminum) */
const IMG = {
  /* Large hero: modern glazing */
  hero:
    "https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?q=80&w=1920&auto=format&fit=crop",
  /* Inset hero: slim frame closeup */
  heroInset:
    "https://images.unsplash.com/photo-1529429612779-c8e40ef2f36e?q=80&w=1400&auto=format&fit=crop",

  /* Thumbs for the hero rail (windows & façades) */
  gallery: [
    "https://images.unsplash.com/photo-1519710164239-da123dc03ef4?q=80&w=1400&auto=format&fit=crop", // interior window
    "https://images.unsplash.com/photo-1501183638710-841dd1904471?q=80&w=1400&auto=format&fit=crop", // large glass opening / door
    "https://images.unsplash.com/photo-1484154218962-a197022b5858?q=80&w=1400&auto=format&fit=crop", // façade glazing
    "https://images.unsplash.com/photo-1460353581641-37baddab0fa2?q=80&w=1400&auto=format&fit=crop", // classic window
  ],

  /* Product cards – mapped to product types */
  prod: [
    // Casement Window
    "https://images.unsplash.com/photo-1523359346063-d879354c0ea5?q=80&w=1400&auto=format&fit=crop",
    // Sliding Window
    "https://images.unsplash.com/photo-1519710164239-da123dc03ef4?q=80&w=1400&auto=format&fit=crop",
    // Lift & Slide Door / entrance
  ...
  /* Projects rail (façades, villas, retail) */
  projects: [
...
/*********************** i18n RESOURCES ***********************/
/** Text sourced from EGYWIN Company Profile (EN+AR),
 * lightly edited for web brevity/clarity.
 */
const RES = {
  en: {
    nav: {
    ...
    hero: {
      ...
      /** From “About us”: established 2006, uPVC; design/manufacture/install; durability, energy efficiency, modern aesthetics. */
      subtitle:
        "Established in 2006, we design, manufacture, and install high-quality uPVC & aluminum windows and doors for homes and businesses in Egypt — delivering durability, energy efficiency, and modern aesthetics.",
      bullets: ["uPVC & Aluminum", "Acoustic & Thermal", "Security & Durability"],
      ...
      list: [
        {
          ...
          d: "Bespoke shop drawings and performance modeling to meet site and climate needs.",
        },
        {
          h: "Manufacturing",
          d: "Advanced fabrication of uPVC/aluminum systems with strict quality checks.",
        },
        {
          h: "Installation",
          d: "Certified teams, site supervision, and air/water sealing tests.",
        },
        {
          h: "After-Sales",
    ...
    products: {
      tag: "Our Products",
      tabs: ["Windows", "Doors", "Shutters", "Curtain Wall"],
      mega: {
        lead: "Popular lines",
        cols: [
          { h: "Windows", items: ["Casement", "Sliding", "Tilt & Turn"], img: IMG.prod[0] },
          { h: "Doors", items: ["Entrance", "Lift & Slide", "French"], img: IMG.prod[2] },
          { h: "Shutters", items: ["Manual", "Motorized", "Security"], img: IMG.prod[1] },
        ],
      },
      /** Directly reflecting the PDF product catalog */
      list: [
        {
          name: "Casement Window",
          desc:
            "Excellent ventilation, sealing, and security; various opening styles and finishes.",
          img: IMG.prod[0],
          cat: "Windows",
        },
        {
          name: "Sliding Window",
          desc:
            "Space-saving, smooth operation with wide views; noise reduction and weather resistance.",
          img: IMG.prod[1],
          cat: "Windows",
        },
        {
          name: "Tilt & Turn Window",
          desc: "Two-way opening for all-season comfort, safety, and easy cleaning.",
          img: IMG.prod[3],
          cat: "Windows",
        },
        {
          name: "uPVC Entrance Door",
          desc:
            "Elegant, insulated door sets with multi-point locking for strength and security.",
          img: IMG.prod[0],
          cat: "Doors",
        },
        {
          ...
          desc:
            "Large panels and featherlight action — seamless indoor/outdoor living.",
          img: IMG.prod[2],
          cat: "Doors",
        },
        {
          name: "Aluminum Roller Shutter",
          desc:
            "Manual or motorized; sun, dust, noise, and intrusion control with modern convenience.",
          img: IMG.prod[1],
          cat: "Shutters",
        },
        {
          name: "Curtain Wall",
          desc: "Lightweight façade with thermal and acoustic performance.",
          img: IMG.gallery[2],
          cat: "Curtain Wall",
        },
      ],
      ...
      list: [
        {
          ...
          d: "Multi-chamber profiles and insulated glazing reduce heat transfer.",
        },
        {
          h: "Acoustic Control",
          d: "Thicker and laminated panes significantly cut exterior noise.",
        },
        {
          h: "Security",
          d: "Multi-point locking and reinforced frames deter intrusion.",
        },
        {
          h: "Sealing",
          d: "Gaskets and tight tolerances ensure air and water tightness.",
        },
      ],
    },
    materials: {
      ...
      list: [
        {
          h: "uPVC Profiles — Adopen",
          d:
            "High-performance, eco-friendly, weather-resistant profiles with excellent insulation.",
        },
        {
          h: "Glass — Saint-Gobain",
          d:
            "Advanced thermal/acoustic insulation, UV and solar control, with safety and clarity.",
        },
        {
          h: "Hardware — Kale Kilit",
          d:
            "Durable locks, handles, hinges and hardware with smooth functionality and security.",
        },
        {
          h: "Aluminum Shutters — Madar",
          d:
            "Local, high-quality aluminum shutters; manual or motorized for privacy and protection.",
        },
      ],
    },
    projects: {
      tag: "Recent Projects",
      lead:
        "From modern villas to commercial façades — precision, performance, and beauty.",
    },
    partners: { tag: "Major Partnerships", list: ["Adopen", "Saint-Gobain", "Kale Kilit", "Madar"] },
    process: {
      tag: "Process",
      steps: [
      ...
      list: [
        {
          ...
          a: "5-year profile warranty, 2-year hardware/installation.",
        },
    ...
    testimonials: {
      ...
      list: [
        {
          q: "Seamless from design to install — night and day difference in noise.",
          a: "H. Kamal",
          r: 5,
        },
        { q: "Beautiful slim frames and the AC bill dropped!", a: "S. Farouk", r: 5 },
  ...
  ar: {
    ...
    hero: {
      ...
      subtitle:
        "تأسست عام 2006 — نصمّم ونصنّع ونركّب نوافذ وأبواب uPVC وألومنيوم عالية الجودة في مصر، بمتانة وكفاءة طاقة ولمسات عصرية.",
      bullets: ["uPVC وألومنيوم", "عزل حراري وصوتي", "أمان ومتانة"],
    ...
    services: {
      ...
      list: [
        {
          h: "التصميم والهندسة",
          d: "حلول مخصّصة ورسومات تنفيذ ونمذجة أداء وفق الموقع والمناخ.",
        },
        {
          h: "التصنيع",
          d: "تصنيع متقدّم لأنظمة uPVC/ألومنيوم مع فحوصات جودة صارمة.",
        },
    ...
    products: {
      tag: "منتجاتنا",
      tabs: ["نوافذ", "أبواب", "رول", "كرتن وول"],
      mega: {
        lead: "خطوط شائعة",
        cols: [
          { h: "نوافذ", items: ["مفصلية", "منزلقة", "تلت آند تيرن"], img: IMG.prod[0] },
          { h: "أبواب", items: ["دخول", "ليفت آند سلايد", "فرنش"], img: IMG.prod[2] },
          { h: "رول", items: ["يدوي", "موتور", "أمان"], img: IMG.prod[1] },
        ],
      },
      list: [
        {
          name: "نافذة مفصلية",
          desc: "تهوية ممتازة وإحكام وأمان؛ أنماط فتح وتشطيبات متعددة.",
          img: IMG.prod[0],
          cat: "نوافذ",
        },
        {
          name: "نافذة منزلقة",
          desc: "توفّر المساحة وعملية سلسة ورؤية واسعة؛ تخفيف الضوضاء ومقاومة للعوامل.",
          img: IMG.prod[1],
          cat: "نوافذ",
        },
        {
          name: "تلت آند تيرن",
          desc: "فتح بطريقتين لراحة وأمان وسهولة تنظيف.",
          img: IMG.prod[3],
          cat: "نوافذ",
        },
        {
          name: "باب دخول uPVC",
          desc: "أبواب معزولة بإقفال متعددة ولمسة أنيقة للمتانة والأمان.",
          img: IMG.prod[0],
          cat: "أبواب",
        },
        {
          name: "باب ليفت آند سلايد",
          desc: "ألواح كبيرة وحركة خفيفة — تواصل داخلي/خارجي سلس.",
          img: IMG.prod[2],
          cat: "أبواب",
        },
        {
          name: "رول ألومنيوم",
          desc: "يدوي/موتور — تحكم بالشمس والغبار والضوضاء والأمان.",
          img: IMG.prod[1],
          cat: "رول",
        },
        {
          name: "كرتن وول",
          desc: "واجهة خفيفة بأداء حراري وصوتي.",
          img: IMG.gallery[2],
          cat: "كرتن وول",
        },
      ],
    ...
    features: {
      ...
      list: [
        ...
        { h: "عزل صوتي", d: "ألواح سميكة ومصفحة تحدّ الضجيج الخارجي." },
    ...
    materials: {
      ...
      list: [
        {
          h: "uPVC — Adopen",
          d: "بروفايلات عالية الأداء ومستدامة ومقاوِمة للعوامل بعزل ممتاز.",
        },
        {
          h: "الزجاج — Saint-Gobain",
          d: "عزل حراري/صوتي وتحكّم شمسي وUV مع سلامة ووضوح.",
        },
        {
          h: "الملحقات — Kale Kilit",
          d: "أقفال ومقابض ومفصلات متينة بأداء سلس وخصائص أمان.",
        },
        {
          h: "رول ألومنيوم — Madar",
          d: "ستائر ألومنيوم محلية عالية الجودة (يدوي/موتور) للخصوصية والحماية.",
        },
      ],
    },
    projects: {
      tag: "مشاريع حديثة",
      lead: "من فيلات حديثة إلى واجهات تجارية — دقة وأداء وجمال.",
    },
    partners: { tag: "الشراكات الرئيسية", list: ["Adopen", "Saint-Gobain", "Kale Kilit", "Madar"] },
    process: {
      tag: "العملية",
      steps: [
    ...
    faq: {
      ...
      list: [
        ...
        { q: "هل تقومون بمعاينات؟", a: "نعم — زيارات ومعاينات في جميع المحافظات." },
        { q: "ما هي المدد؟", a: "عادة 3–6 أسابيع حسب النطاق والتشطيب." },
      ],
    },
    testimonials: {
    ...
    awards: {
      tag: "اعتمادات وذكر",
      list: ["جودة متوافقة مع ISO", "شريك Saint-Gobain مفضّل", "مطابقة واختبارات محلية"],
    },
    calculator: {
    ...
    marq: ["uPVC", "ألمنيوم", "منزلقة", "مفصلية", "ليفت & سلايد", "كرتن وول", "رول", "Low-E", "مصفّح"],
  },
};
        ...
        >
          <div className="grid md:grid-cols-[1.1fr_.9fr]">
            ...
            <div className="relative hidden md:block">
              <img
                src={config.cols[anchor % config.cols.length].img}
                alt="preview"
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(252,247,241,0.6), transparent)",
                }}
              />
            </div>
          </div>
...
function CommandPalette({ open, onClose, items }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[80] grid place-items-start pt-24 px-4"
    ...
    >
      ...
      >
        ...
        <div className="max-h-72 overflow-auto" style={{ color: PALETTE.cacao }}>
          ...
          {!filtered.length && (
            <div className="px-4 py-6 text-sm" style={{ color: PALETTE.cacaoSoft }}>
              No matches
            </div>
          )}
        </div>
...
function Header({ onLangToggle }) {
  ...
  const productsMega = t("products.mega", {
    returnObjects: true,
    defaultValue: { lead: "Popular", cols: [] },
  });
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            {navItems.map((item, idx) => (
              <div key={item.id} className="relative">
                <a
                  ...
                  style={{
                    color: active === item.id ? PALETTE.cacao : PALETTE.cacaoSoft,
                  }}
                >
                  <span className="relative">
                    ...
                    <span
                      className={cn(
                        "absolute start-0 -bottom-0.5 h-[2px] transition-all",
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="hidden sm:inline-flex items-center gap-2 h-10 px-3 rounded-xl text-sm"
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4">
                  {servicesList.map((s, i) => (
                    <div key={i} className="p-6 border-s" style={{ borderColor: PALETTE.border }}>
                      <div className="font-black" style={{ color: PALETTE.cacao }}>
                        {s.h}
                      </div>
      ...
      {/* Mobile Drawer */}
      <div
        className={cn("lg:hidden", openMobile ? "block" : "hidden")}
        style={{
          borderBottom: `1px solid ${PALETTE.border}`,
          background: "rgba(246,239,231,0.95)",
          backdropFilter: "blur(6px)",
          color: PALETTE.cacaoSoft,
        }}
      >
        <div className="px-4 py-3 grid gap-2 font-semibold">
          {[
            { id: "showcase", href: "#showcase", mega: null },
            { id: "products", href: "#products", mega: "products" },
            { id: "services", href: "#services", mega: "services" },
            { id: "materials", href: "#materials", mega: null },
            { id: "projects", href: "#projects", mega: null },
            { id: "process", href: "#process", mega: null },
            { id: "faq", href: "#faq", mega: null },
            { id: "contact", href: "#contact", mega: null },
          ].map((item) => (
            <details
              key={item.id}
              onToggle={(e) => {
                const open = e.currentTarget.open;
                document.querySelectorAll("#mobile-acc details").forEach((d) => {
            ...
            >
              <summary className="cursor-pointer list-none flex items-center justify-between py-2">
                <a href={item.href} className="flex-1">
                  {/** label resolved above */}
                </a>
                {item.mega ? <Chevron /> : null}
              </summary>
              {item.mega === "products" && (
                <div className="ps-4 grid gap-2" id="mobile-acc">
                  {productsMega.cols.map((c) => (
                    <div key={c.h}>
                      ...
                      <ul className="ps-4 text-sm" style={{ color: PALETTE.cacaoSoft }}>
                        {c.items.map((x) => (
                          <li key={x}>
                            <a href="#products" className="block py-1">
                              {x}
                            </a>
                          </li>
                        ))}
              ...
              {item.mega === "services" && (
                <div className="ps-4 grid gap-2">
                  {servicesList.map((s, i) => (
                    <div key={i}>
                      <div className="text-sm font-black" style={{ color: PALETTE.cacao }}>
                        {s.h}
                      </div>
      ...
      <CommandPalette
        ...
        items={[
          { href: "#showcase", label: t("nav.showcase", "Showcase") },
          { href: "#products", label: t("nav.products", "Products") },
          { href: "#services", label: t("nav.services", "Services") },
          { href: "#materials", label: t("nav.materials", "Materials") },
...
function ScrollProgressThin() {
  ...
  return (
    <div className="h-0.5 w-full">
      <div
        className="h-full"
        style={{ background: PALETTE.caramel, width: `${p}%` }}
      />
    </div>
  );
}
  ...
  return (
    <section id="home" className="relative isolate overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <img
          src={IMG.hero}
          alt="Large glazing in a modern space"
      ...
      <div className="max-w-7xl mx-auto px-4 pt-12 pb-10 grid lg:grid-cols-[1.1fr_.9fr] items-center gap-10">
        ...
        <div>
          <p
            className="tracking-[0.35em] text-xs sm:text-sm"
            style={{ color: PALETTE.cacaoSoft }}
          >
            {t("hero.pre", "EGYWIN")}
          </p>
          ...
          >
            <span
              className="inline-block [animation:reveal_800ms_cubic-bezier(.2,.8,.2,1)_both]"
              style={{ color: PALETTE.caramel }}
            >
              {t("hero.titleA", "Classical craftsmanship")}
            </span>
            <br />
            <span className="inline-block [animation:reveal_1000ms_120ms_cubic-bezier(.2,.8,.2,1)_both]">
              {t("hero.titleB", "meets industrial modernity")}
            </span>
            <br />
            <span className="inline-block [animation:reveal_1000ms_220ms_cubic-bezier(.2,.8,.2,1)_both]">
              {t("hero.titleC", "for brighter, quieter spaces.")}
            </span>
          </h1>
          <p
            className="mt-3 max-w-prose text-base sm:text-lg"
            style={{ color: PALETTE.cacaoSoft }}
          >
            {t("hero.subtitle")}
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            >
              {t("hero.explore", "Explore Collection")}
            </a>
            <a
              href="#contact"
        ...
        {/* Visual Card */}
        <div className="relative hidden md:block">
          <div className="absolute -top-10 -end-6 w-40 h-40 [animation:spin_26s_linear_infinite] opacity-80">
            <GearSvg />
          </div>
          <div
          ...
          >
            ...
            >
              <img src={IMG.heroInset} alt="Slim frame" className="w-full h-56 object-cover" />
              <div
                className="absolute inset-0 pointer-events-none"
                style={{
                  background:
                    "radial-gradient(400px 140px at 80% 10%, transparent, rgba(252,247,241,.8))",
                }}
              />
              <span
            ...
            <p className="mt-3 text-sm" style={{ color: PALETTE.cacaoSoft }}>
              Refined profiles, generous glass, perfect seals. A timeless palette that pairs
              classical warmth with industrial precision.
            </p>
      ...
      <a
        href="#showcase"
        className="group absolute left-1/2 -translate-x-1/2 bottom-6 inline-flex flex-col items-center"
        aria-label="Scroll to showcase"
      >
        <span className="text-xs font-semibold" style={{ color: PALETTE.cacaoSoft }}>
          {dirRtl ? "تابع للأسفل" : "Scroll to showcase"}
        </span>
        <span
          className="mt-1 grid place-items-center h-10 w-10 rounded-full border [animation:bouncey_1.4s_infinite]"
          style={{ borderColor: PALETTE.border, color: PALETTE.caramel }}
        >
          ↓
        </span>
      </a>
...
function HeroStat({ label, value, locale }) {
  ...
  return (
    ...
    >
      ...
      <div className="text-xs tracking-wider" style={{ color: PALETTE.cacaoSoft }}>
        {label}
      </div>
    </div>
  );
...
function Products() {
  ...
  const filtered =
    tab && list.some((p) => p.cat === tab) ? list.filter((p) => p.cat === tab) : list;
  React.useEffect(() => {
    if (!tab && tabs.length) setTab(tabs[0]);
  }, [tabs, tab]);
  const onKey = (e) => {
        ...
        <div className="mt-4 flex flex-wrap gap-2" role="tablist" aria-label="Product categories" onKeyDown={onKey}>
          {tabs.map((x) => (
            <button
              ...
              style={{
                border: `1px solid ${tab === x ? PALETTE.caramel : PALETTE.border}`,
                background: tab === x ? PALETTE.caramel : "white",
                color: tab === x ? "white" : PALETTE.cacao,
              }}
            >
              {x}
            </button>
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-3 flex justify-between items-center">
                  <a href="#contact" className="font-bold" style={{ color: PALETTE.caramel }}>
                    Get Specs
                  </a>
    ...
    >
      <div className="p-4">
        ...
        <div className="relative aspect-[16/10] rounded-xl overflow-hidden">
          ...
          />
          <img
            src="https://images.unsplash.com/photo-1529429612779-c8e40ef2f36e?q=80&w=1600&auto=format&fit=crop"
            alt="After"
            className="absolute inset-0 w-full h-full object-cover"
    ...
    <section id="materials" className="py-16" style={{ color: PALETTE.cacao }}>
      <div className="max-w-7xl mx-auto px-4">
        <h2
          ...
          style={{ color: PALETTE.caramel }}
        >
          {t("materials.tag", "Materials & Components")}
        </h2>
        <div className="mt-6 grid md:grid-cols-2 gap-4">
          {materials.map((m, i) => (
            <div
              ...
              style={{ background: "white", border: `1px solid ${PALETTE.border}` }}
            >
              <h4 className="font-black mb-1" style={{ color: PALETTE.cacao }}>
                {m.h}
              </h4>
        ...
        <div id="partners" className="mt-12">
          <h2
            ...
            style={{ color: PALETTE.caramel }}
          >
            {t("partners.tag", "Major Partnerships")}
          </h2>
          <div className="mt-4 flex flex-wrap gap-3">
            {partners.map((p) => (
              <span
                key={p}
                className="inline-flex items-center h-9 px-4 rounded-full"
                style={{
                  background: PALETTE.linen,
                  border: `1px solid ${PALETTE.border}`,
                  color: PALETTE.cacao,
    ...
    <section id="process" className="py-16" style={{ background: "white", color: PALETTE.cacao }}>
      <div className="max-w-7xl mx-auto px-4">
        <h2
          ...
          style={{ color: PALETTE.caramel }}
        >
          {t("process.tag", "Process")}
        </h2>
        <ol className="relative mt-6 border-s-2 ps-6" style={{ borderColor: `${PALETTE.caramel}66` }}>
          {steps.map((s, i) => (
            <li key={i} className="mb-6">
              <div
                className="absolute -start-2.5 mt-1 h-5 w-5 rounded-full"
                style={{ background: "white", border: `2px solid ${PALETTE.caramel}` }}
              />
              <div className="font-black" style={{ color: PALETTE.cacao }}>
                {s.h}
              </div>
        ...
        <div id="faq" className="mt-12 grid lg:grid-cols-2 gap-8">
            ...
            <div className="mt-4 grid gap-4">
              {faq.map((f, i) => (
                <details
                  ...
                  style={{ background: PALETTE.linen, border: `1px solid ${PALETTE.border}` }}
                >
                  <summary className="cursor-pointer list-none flex items-center justify-between">
                    <span className="font-bold" style={{ color: PALETTE.cacao }}>
                      {f.q}
                    </span>
                    <span className="[transition:transform_200ms]" style={{ color: PALETTE.caramel }}>
                      ⌄
                    </span>
                  </summary>
                  <p className="mt-2 text-sm" style={{ color: PALETTE.cacaoSoft }}>
                    {f.a}
                  </p>
                </details>
              ))}
          ...
          <div>
            <h3
              ...
              style={{ color: PALETTE.caramel }}
            >
              {t("testimonials.tag", "What clients say")}
            </h3>
            <div className="mt-4 grid gap-3">
              {testi.map((tt, i) => (
                <figure
                  ...
                  style={{ background: "white", border: `1px solid ${PALETTE.border}` }}
                >
                  <blockquote className="text-sm" style={{ color: PALETTE.cacao }}>
                    “{tt.q}”
                  </blockquote>
                  <figcaption className="mt-2 text-xs" style={{ color: PALETTE.cacaoSoft }}>
                    <span className="inline-flex items-center gap-2">
                      <img
                        src={IMG.avatar[i % IMG.avatar.length]}
                        alt="Client"
            ...
            <h3
              className="mt-6 text-sm font-extrabold uppercase tracking-widest"
              style={{ color: PALETTE.caramel }}
            >
              {t("awards.tag", "Certifications & Mentions")}
            </h3>
            <div className="mt-3 flex flex-wrap gap-2">
              {awards.map((x, i) => (
                <span
                  key={i}
                  className="inline-flex items-center px-3 h-8 rounded-full text-xs font-bold"
                  style={{
                    background: PALETTE.linen,
                    border: `1px solid ${PALETTE.border}`,
                    color: PALETTE.cacao,
...
function CalculatorContact() {
  ...
  /** Simplified estimator for demo purposes */
  const kWhSaved = Math.max(
    0,
    ((uOld - uNew) / uOld) * area * ac * 30 * season * 0.05
  );
      ...
      <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-10 items-start">
        <div className="rounded-2xl p-6 bg-white" style={{ border: `1px solid ${PALETTE.border}` }}>
          ...
          <p className="mb-4" style={{ color: PALETTE.cacaoSoft }}>
            {t("calculator.lead", "Estimate yearly savings and ROI after upgrading windows.")}
          </p>
          <div className="grid sm:grid-cols-2 gap-3">
            <Field label={t("calculator.inputs.area", "Glazing Area (m²)")} value={area} onChange={setArea} step={1} min={1} />
            <Field label={t("calculator.inputs.rate", "kWh price (EGP)")} value={rate} onChange={setRate} step={0.05} min={0} />
            <Field label={t("calculator.inputs.ac", "AC hours/day")} value={ac} onChange={setAC} step={1} min={0} max={24} />
            <Field label={t("calculator.inputs.season", "Cooling months")} value={season} onChange={setSeason} step={1} min={1} max={12} />
            <Field label={t("calculator.inputs.uOld", "Old U-Value")} value={uOld} onChange={setUOld} step={0.1} min={0.1} />
            <Field label={t("calculator.inputs.uNew", "New U-Value")} value={uNew} onChange={setUNew} step={0.1} min={0.1} />
            <Field label={t("calculator.inputs.cost", "Upgrade cost (EGP)")} value={cost} onChange={setCost} step={50} min={0} />
          </div>
          <div className="mt-4 grid sm:grid-cols-3 gap-3">
            <StatCard title={t("calculator.result.saved", "Estimated kWh saved/year")} value={Math.round(kWhSaved).toLocaleString()} />
            <StatCard title={t("calculator.result.money", "EGP saved/year")} value={moneyFmt(egpSaved)} />
            <StatCard title={t("calculator.result.payback", "Estimated payback (months)")} value={`${paybackMonths}`} />
          </div>
        </div>
        <ContactForm />
      </div>
...
function Field({ label, value, onChange, step = 1, min, max }) {
  return (
    <label className="grid gap-1">
      <span className="text-sm font-bold" style={{ color: PALETTE.cacao }}>
        {label}
      </span>
      <input
        type="number"
...
function StatCard({ title, value }) {
  return (
    <div
      ...
      style={{ background: PALETTE.linen, border: `1px solid ${PALETTE.border}` }}
    >
      <div className="text-xs" style={{ color: PALETTE.cacaoSoft }}>
        {title}
      </div>
 ...
 * - Reads from existing i18n content to answer FAQs
 * - Quick actions + ManyChat handoff (via VITE_MANYCHAT_URL)
 ******************************************************************/
...
function AssistantWidget(){
  ...
  React.useEffect(()=>{
    if(open && messages.length===0){
      ...
      pushBot(ar
        ? "مرحباً! أنا مساعد إيجي وين. أستطيع مساعدتك في المنتجات، الأسعار التقديرية، توفير الطاقة، وحجز زيارة. اختر من المقترحات بالأسفل أو اكتب سؤالك."
        : "Hi! I’m the EGYWIN assistant. I can help with products, pricing guidance, energy savings and booking a site visit. Pick a quick action below or ask anything.");
      // show quick chips as a system message
      pushBotQuickActions();
    }
  ...
  function pushBotQuickActions(){
    setMessages(m=>[...m, {role:'system', quick:true, ts:Date.now()}]);
  }
  ...
  function respond(q){
    ...
    // intent: products
    if(/product|window|door|shutter|curtain|نافذ|باب|رول|كرتن/.test(s)){
      const list = t('products.list', { returnObjects:true, defaultValue: [] });
    ...
    // intent: energy / calculator
    if(/energy|save|kwh|bill|calculator|roi|توفير|طاقة|حساب/.test(s)){
      pushBot((ar
        ? "يمكنك استخدام حاسبة توفير الطاقة أسفل الصفحة. سنقدّم تقديراً بسيطاً الآن:"
        : "You can use the Energy Savings Estimator below. Here’s a quick rough estimate:"));
      // simple illustrative numbers (same defaults as calculator)
      const area=30, rate=1.35, ac=8, season=6, uOld=5.8, uNew=1.6;
      const kWh = Math.max(0, ((uOld-uNew)/uOld) * area * ac * 30 * season * 0.05);
      const egp = kWh * rate;
      pushBot(`${ar? "تقدير توفير الطاقة سنوياً": "Estimated yearly savings"}: ~${Math.round(kWh).toLocaleString()} kWh • ${Math.round(egp).toLocaleString()} EGP\n${ar? "جرّب المُدخلات في الآلة الحاسبة لنتيجة أدق ↓" : "Try your own inputs in the calculator for accuracy ↓"}`);
      return;
    }
    // intent: quote / call / visit
    if(/quote|price|call|visit|site|عرض|سعر|مكالمة|زيارة/.test(s)){
      pushBot(ar
        ? "رائع! من فضلك اكتب اسمك ورقم هاتفك/البريد وسنتواصل خلال وقت قصير. يمكنك أيضاً استخدام زر واتساب."
        : "Great! Please share your name and phone/email and we’ll get back shortly. You can also tap WhatsApp.");
      return;
    }
    // intent: whatsapp
    ...
    // default
    pushBot(ar
      ? "سعيد بمساعدتك. يمكنك السؤال عن المنتجات، الخدمات، المواد، التوفير، أو طلب زيارة. جرب: \"ما أنواع النوافذ؟\""
      : "Happy to help. Ask about products, services, materials, savings, or request a visit. Try: “What window types do you have?”");
  }
  ...
  return (
    <>
      ...
      <button
        onClick={()=>setOpen(o=>!o)}
        className="fixed z-[70] bottom-24 left-4 h-12 w-12 rounded-full shadow-lg grid place-items-center"
        style={{ background: PALETTE.caramel, color: "white" }}
      ...
      {/* Panel */}
      {open && (
        <div className="fixed z-[80] bottom-40 left-4 w-[90vw] max-w-[380px] rounded-2xl shadow-xl overflow-hidden"
             style={{ background: "white", border:`1px solid ${PALETTE.border}`}}>
          {/* Header */}
          <div className="px-4 py-3 flex items-center justify-between"
               style={{ background: PALETTE.linen, borderBottom:`1px solid ${PALETTE.border}`, color:PALETTE.cacao }}>
            <div className="font-black">EGYWIN Assistant</div>
            <div className="flex items-center gap-2">
              {MC_URL ? (
                <button
                  onClick={()=>window.open(MC_URL, "_blank")}
              ...
              m.quick ? (
                ...
                <div key={idx} className={m.role==='user' ? "text-right" : "text-left"}>
                  <div className="inline-block px-3 py-2 rounded-2xl whitespace-pre-wrap"
                       style={ m.role==='user'
                         ? { background: PALETTE.caramel, color:'white' }
          ...
          <div className="px-2 py-2 flex items-center gap-2" style={{ borderTop:`1px solid ${PALETTE.border}` }}>
            <input
              ...
              placeholder={i18n.language?.startsWith('ar') ? "اكتب سؤالك..." : "Type your question..."}
              className="flex-1 px-3 py-2 rounded-xl outline-none"
              style={{ border:`1px solid ${PALETTE.border}`, color:PALETTE.cacao }}
            />
            <button onClick={()=>handleSend()} className="h-10 px-4 rounded-xl font-bold"
                    style={{ background: PALETTE.caramel, color:'white' }}>
  ...
  return (
    <form
      onSubmit={(e) => {
        ...
        const honey = f.querySelector('input[name="company"]');
    ...
    >
      ...
      <div className="mt-5 text-sm" style={{ color: PALETTE.cacaoSoft }}>
        ...
        <div>
          <b>{t("contact.phone")}:</b>{" "}
          <a href="tel:+201222131118">+20 1222131118</a>
        </div>
        <div>
          <b>Web:</b>{" "}
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <nav className="text-sm flex gap-4" style={{ color: PALETTE.cacaoSoft }}>
      ...
      {/* Credit line requested (content-only addition, minimal visual impact) */}
      <div
      ...
      >
        made with passion and precison by{" "}
...
function Marquee() {
  const { t } = useTranslation();
  const items = t("marq", { returnObjects: true, defaultValue: [] });
  return (
    <div className="border-top" style={{ borderColor: PALETTE.border, background: PALETTE.cream }}>
      <div className="overflow-hidden">
        <div
          className="flex gap-6 py-3 [animation:marq_24s_linear_infinite] whitespace-nowrap"
          style={{ color: PALETTE.cacao }}
        >
          {[...items, ...items].map((x, i) => (
